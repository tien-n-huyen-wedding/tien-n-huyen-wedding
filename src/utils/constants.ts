...
export const PACKAGES: Record<string, { name: string; ceremonyInfo: MainCeremonyCardProps; weddingPartyInfo: WeddingPartyCardProps }> = {
  mainParty: {
    name: "Nhà nam",
    ceremonyInfo: CeremonyInfo,
    weddingPartyInfo: WeddingPartyInfo,
  },
  bridePartySectionOne: {
    name: "Nhà nữ xuất 1",
