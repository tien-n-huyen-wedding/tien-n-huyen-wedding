...
export default function CoupleSection({
  ...
  brideName = "Lệ Huyền",
  groomDescription = "“Cô ấy là một HR tận tâm, mang vẻ đẹp dịu dàng và nụ cười tỏa nắng.\nẨn sau sự mạnh mẽ là một tâm hồn nhạy cảm, luôn chứa đựng tình yêu và sự chân thành vô bờ bến.”",
  brideDescription = "“Anh ấy là người thẳng thắn, bộc trực nhưng luôn thể hiện tình yêu một cách dịu dàng và ấm áp với cô dâu”."
}: CoupleSectionProps) {
